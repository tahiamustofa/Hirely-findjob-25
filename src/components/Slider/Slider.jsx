      ...
      <div className="grid xl:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-1 md:gap-2 mb-4 mx-auto">
        {categories.map((category, index) => (
          <button
            ...
            className={`lg:px-4 px-1 py-2 ${activeCategory.name === category.name ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
          >
            {category.name}
          </button>
        ))}
              ...
              <div key={index} className={`flex-none w-${100 / slidesToShow}% p-4  mx-auto`}>
                <div className="bg-white p-6 rounded-lg shadow-md md:h-[450px] h-96">
                 ...
                 <div className='flex  justify-between'>
                  <button className="mt-4 bg-white text-[#0079C1] px-2 py-2 rounded shadow-2xl border border-[#D6D6D6] hover:animate-bounce">More info</button>
